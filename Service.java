package com.example.nsx.myapplication;
...
public class Service extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btn6on = getView().findViewById(R.id.on6);
        btn6off = getView().findViewById(R.id.off6);
        ...
        btn6on.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference led1 = database.getReference("LED_6");
                led1.setValue(1);
            }
        });

        btn6off.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseDatabase database = FirebaseDatabase.getInstance();
                DatabaseReference led1 = database.getReference("LED_6");
